...
class StaffController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            'full_name' => 'required|string|max:100|unique:staff,full_name', 
            ...
            'bank_name' => 'nullable|in:Maybank,CIMB,Public Bank,RHB,Hong Leong,AmBank,UOB,OCBC,HSBC,Standard Chartered,Alliance Bank,Affim Bank,Bank Islam,Bank Muamalat,Agrobank,BSN',
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'regex:/^([0-9\s\-\+\(\)]*)$/',
            'min:10',
            'unique:staff,phone,' . $staff->staff_id . ',staff_id'
            ],
