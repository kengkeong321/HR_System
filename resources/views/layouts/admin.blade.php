  ...
  <head>
    ...
    <style>
      ...
      .sidebar { 
        ...
        transition: width .2s; 
        position: sticky; 
        top: 56px; /* offset so it sits below the navbar */
      ...
      .sidebar-collapsed .sidebar h5 { display: none; }
      .sidebar-collapsed .sidebar .nav-link { justify-content: center; padding-left: 7px;}
      .sidebar-collapsed .sidebar .nav-link .label { display: none; }
    ...
    <script>
      (function () {
        ...
        document.addEventListener('click', function (e) {
          ...
          const page = (() => {
            try { return new URL(href, window.location.origin).searchParams.get('page') || 1; } catch (e) { return 1; }
          })();
